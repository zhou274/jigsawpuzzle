...
{	
    ...
    public PuzzleElement(int _top, int _left, int _bottom, int _right, int _baseSize, Texture2D _subElement, Color[] _topPixels, Color[] _leftPixels, bool _flatElements = false)
    {
        top     = _top;
        left    = _left;
        bottom  = _bottom;
